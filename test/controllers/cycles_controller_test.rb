...
class CyclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cycle" do
    assert_difference('Cycle.count') do
      post cycles_url, params: { cycle: { description: @cycle.description, end_date: @cycle.end_date, name: @cycle.name } }
    end
  ...
  test "should update cycle" do
    patch cycle_url(@cycle), params: { cycle: { description: @cycle.description, end_date: @cycle.end_date, name: @cycle.name } }
